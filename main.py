...
def main():
    ...
    if thread is None:
        print('¡No se encontró ningún hilo!')
        return
    ...
    # Descargar capturas de pantalla de la publicación de Reddit y sus comentarios
    get_screenshots_of_reddit_posts(reddit_thread=thread, reddit_comments=comments, screenshot_num=1)

    # Crear un directorio mp3 para los archivos de texto a voz (tts)
    ...
    print("Obteniendo archivos mp3...")

    # Descargar archivos tts
    ...
    # Asegurarse de que el tts del título y comentarios no exceda la duración total
    ...
    # Convertir la pausa (en segundos) a milisegundos
